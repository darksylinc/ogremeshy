...
====================
Load specific resources.cfg:   wxOgreMeshViewer.exe "/r:C:\MyFolder\resources.cfg"
Show OGRE Config dialog:    wxOgreMeshViewer.exe -setup
Load a mesh:                wxOgreMeshViewer.exe "C:\MyFolder\MyMesh.mesh"
Display Cmd help:           wxOgreMeshViewer.exe -h
...
Q: I'm in linux, I get to the Render API OpenGL selection screen, hit ok, and then the program exits.
A: Check the folder "~/.ogremeshy" exists, which is where Ogre Meshy saves all config data. (i.e. /home/myusername/.ogremeshy)

Q: I'm in linux, and selecting a background colour or a bone text colour results always in black
...
Q: I'm on linux and it doesn't work
